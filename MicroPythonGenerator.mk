...
%.py.cfg: | silent
	$(V)$(MAKE) --file=$(MICROPYTHON_API_GENERATOR_DIR)/MicroPythonModule.mk $(MAKEFLAGS) "MAKE_INC_PATH=$(MAKE_INC_PATH)" "PYTHON_ADDITIONAL_PATHS=$(PYTHON_ADDITIONAL_PATHS)" "MICROPYTHON_TARGET=$(MICROPYTHON_TARGET_$*)" "MICROPYTHON_API_GENERATOR_PATH=$(MICROPYTHON_API_GENERATOR_PATH)" "MICROPYTHON_PARSER_CONFIG_PATH=$(MICROPYTHON_PARSER_CONFIG_PATH)" "CPPFLAGS=$(CPPFLAGS)" "CPPFLAGS=$(CPPFLAGS)" "CXXFLAGS=$(CXXFLAGS)" cfg-python-module

clean-python-api: | silent
	$(V)$(RM) $(MICROPYTHON_CPP_FILES) $(MICROPYTHON_HEADERS)
